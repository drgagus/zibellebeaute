    ...
    return (
        <div>
            <div className="container-fluid text-center"  style={{background: '#0099ff'}}>
                <NavLink to="/brand"><img src="img/zibelle.png" className="" alt="brand" width="200"/></NavLink>
                <div className="row">
            ...
            <div className="container-fluid" style={{background: '#ffd700'}}>
                ...
                <Product1 whatsapp="628118821631"/>
                <Product2 whatsapp="628118821631"/>
                <div className="row">
                    <div className="col-lg-12 p-0">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#0099ff" fillOpacity="1" d="M0,32L40,42.7C80,53,160,75,240,69.3C320,64,400,32,480,53.3C560,75,640,149,720,176C800,203,880,181,960,165.3C1040,149,1120,139,1200,122.7C1280,107,1360,85,1400,74.7L1440,64L1440,320L1400,320C1360,320,1280,320,1200,320C1120,320,1040,320,960,320C880,320,800,320,720,320C640,320,560,320,480,320C400,320,320,320,240,320C160,320,80,320,40,320L0,320Z"></path></svg>
                    </div>
            ...
            <div className="container-fluid"  style={{background: '#0099ff'}}>
                <div className="row mb-5">
                    <div className="col-lg-12 text-center">            
                    <h1 className="fw-bold" style={{color:'#ffd700'}}>RESI PENGIRIMAN</h1>
                    </div>
                </div>
            ...
            <div className="container-fluid" style={{background: '#ffd700'}}>
                <div className="row mb-5">
                    <div className="col-lg-12 text-center">            
                    <h1 className="fw-bold" style={{color:'#0f49ff'}}>SOCIAL MEDIA</h1>
                    </div>
                </div>
                <div className="row d-flex justify-content-center">
                    <div className="col-lg-1 col-3 text-center">
                        <a href="https://www.facebook.com/zibellebeauty.simatupang" className="fs-1"><i className="bi bi-twitter"></i></a>
                        <br/>Twitter
                    </div>
                    <div className="col-lg-1 col-3 text-center">
                        <a href="https://www.facebook.com/zibellebeauty.simatupang" className="fs-1"><i className="bi bi-facebook"></i></a>
                        <br/>Facebook
                    </div>
                    <div className="col-lg-1 col-3 text-center">
                        <a href="https://www.instagram.com/zibellebeauty" className="fs-1"><i className="bi bi-instagram"></i></a>
                        <br/>Instagram
                    </div>
                    <div className="col-lg-1 col-3 text-center">
                        <a href="https://www.youtube.com/channel/UC1COyskbxeHSfBU1Au4hkRw" className="fs-1"><i className="bi bi-youtube"></i></a>
                        <br/>YouTube
                    </div>
                </div>
                <div className="row">
                    <div className="col-lg-12 p-0">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#0099ff" fillOpacity="1" d="M0,192L48,197.3C96,203,192,213,288,229.3C384,245,480,267,576,250.7C672,235,768,181,864,181.3C960,181,1056,235,1152,234.7C1248,235,1344,181,1392,154.7L1440,128L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path></svg>
                    </div>
                </div>
            </div>
            ...
            <div className="container-fluid"  style={{background: '#0099ff'}}>
                <div className="row mb-5">
                    <div className="col-lg-12 text-center">            
                    <h1 className="fw-bold" style={{color:'#ffd700'}}>RESELLER</h1>
                    </div>
                </div>
                <div className="row text-center d-flex justify-content-center">
